...
public class AvatarPTA implements Serializable {
    ...
    public String getHairFile() {
        List<BundleRes> lists = FilePathFactory.hairBundleRes();
    ...
    public String getGlassesFile() {
        return getStringByIndex(FilePathFactory.glassesBundleRes(), glassesIndex);
    }

    public String getClothesFile() {
        return getStringByIndex(FilePathFactory.clothesBundleRes(), clothesIndex);
    }
    ...
    public String getBeardFile() {
        return getStringByIndex(FilePathFactory.beardBundleRes(), beardIndex);
    }

    public String getHatFile() {
        List<BundleRes> lists = FilePathFactory.hatBundleRes();
    ...
    public String getShoeFile() {
        return getStringByIndex(FilePathFactory.shoeBundleRes(), shoeIndex);
    }
