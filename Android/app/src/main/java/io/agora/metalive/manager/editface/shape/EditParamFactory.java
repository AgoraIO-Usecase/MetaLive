package io.agora.metalive.manager.editface.shape;
...
import io.agora.metalive.manager.editface.entity.ParamRes;
...
public abstract class EditParamFactory {
    ...
    private static List<ParamRes> parseJson(JSONObject jsonObject, String key) throws Exception {
        ...
        ret.add(new ParamRes(R.drawable.edit_face_selector_item_customize, null));
