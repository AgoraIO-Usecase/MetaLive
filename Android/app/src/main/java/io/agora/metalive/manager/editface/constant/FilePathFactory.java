...
import static io.agora.metalive.manager.editface.EditFaceItemManager.TITLE_EYEBROW_INDEX;
import static io.agora.metalive.manager.editface.EditFaceItemManager.TITLE_EYELASH_INDEX;
import static io.agora.metalive.manager.editface.EditFaceItemManager.TITLE_EYELINER_INDEX;
import static io.agora.metalive.manager.editface.EditFaceItemManager.TITLE_EYESHADOW_INDEX;
import static io.agora.metalive.manager.editface.EditFaceItemManager.TITLE_FACEMAKEUP_INDEX;
import static io.agora.metalive.manager.editface.EditFaceItemManager.TITLE_LIPGLOSS_INDEX;
import static io.agora.metalive.manager.editface.EditFaceItemManager.TITLE_PUPIL_INDEX;
...
public abstract class FilePathFactory {
     ...
     * 头发
     */
    public static List<BundleRes> hairBundleRes() {
     ...
     * 眼镜
     */
    public static List<BundleRes> glassesBundleRes() {
        String configPath = "new/glasses/glasses_config.json";
        return getBundleResForPath(configPath);
    }

    public static int glassesIndex(int shape, int rim) {
        List<BundleRes> bundleRes = glassesBundleRes();
     ...
     * 衣服
     */
    public static List<BundleRes> clothesBundleRes() {
     ...
     * 鞋子
     */
    public static List<BundleRes> shoeBundleRes() {
    ...
    public static List<SpecialBundleRes> decorationsEarBundleRes() {
        ...
        return getBundleResForPath(configPath, JsonUtils.TYPE_DECORATION, 23);
    }
    ...
    public static List<SpecialBundleRes> decorationsFootBundleRes() {
        ...
        return getBundleResForPath(configPath, JsonUtils.TYPE_DECORATION, 24);
    }
    ...
    public static List<SpecialBundleRes> decorationsHandBundleRes() {
        ...
        return getBundleResForPath(configPath, JsonUtils.TYPE_DECORATION, 25);
    }
    ...
    public static List<SpecialBundleRes> decorationsHeadBundleRes() {
        ...
        return getBundleResForPath(configPath, JsonUtils.TYPE_DECORATION, 26);
    }
    ...
    public static List<SpecialBundleRes> decorationsNeckBundleRes() {
        ...
        return getBundleResForPath(configPath, JsonUtils.TYPE_DECORATION, 27);
    }
     ...
     * 帽子
     */
    public static List<BundleRes> hatBundleRes() {
     ...
     * 胡子
     */
    public static List<BundleRes> beardBundleRes() {
    ...
    private static final BundleRes[] SCENES_2D = {
            new BundleRes(AvatarPTA.gender_mid, FilePathFactory.BUNDLE_default_bg, R.drawable.edit_face_selector_item_none),
