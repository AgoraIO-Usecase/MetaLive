package io.agora.metalive.manager.editface;
...
public class EditFaceItemManager {
    ...
    private HashMap<Integer, MultipleItemPair> decorationPairBeanMap;
    private List<SpecialBundleRes> decorationList;


    private HashMap<Integer, MultipleItemPair> markUpPairBeanMap;
    ...
    public void init() {
        ...
        if (FilePathFactory.hairBundleRes().size() > 1) {
        ...
        if (FilePathFactory.beardBundleRes().size() > 1) {
        ...
        // 换装
        if (FilePathFactory.glassesBundleRes().size() > 1) {
            dressUpList.add(TITLE_GLASSES_INDEX);
        }
        if (FilePathFactory.hatBundleRes().size() > 1) {
            dressUpList.add(TITLE_HAT_INDEX);
        }
        if (FilePathFactory.clothesBundleRes().size() > 1) {
        ...
        if (FilePathFactory.shoeBundleRes().size() > 1) {
...
//        iconsManager.put(TITLE_SCENES_2D, R.drawable.icon_dress_background);
    ...
    public void initMakeUpList(AvatarPTA avatarP2A) {
        ...
        makeUpList.add(new SpecialBundleRes(R.drawable.edit_face_selector_item_reset, TITLE_MAKE_UP, "", ""));
        int selectPos = 0;
        // 美妆
        if (FilePathFactory.eyelashBundleRes().size() > 0) {
            makeUpList.addAll(FilePathFactory.eyelashBundleRes());
            markUpPairBeanMap.put(TITLE_EYELASH_INDEX, new MultipleItemPair(selectPos,
        ...
        if (FilePathFactory.eyelinerBundleRes().size() > 0) {
            ...
            markUpPairBeanMap.put(TITLE_EYELINER_INDEX, new MultipleItemPair(selectPos,
        ...
        if (FilePathFactory.eyeshadowBundleRes().size() > 0) {
            ...
            markUpPairBeanMap.put(TITLE_EYESHADOW_INDEX, new MultipleItemPair(selectPos,
        ...
        if (FilePathFactory.eyebrowBundleRes().size() > 0) {
            ...
            markUpPairBeanMap.put(TITLE_EYEBROW_INDEX, new MultipleItemPair(selectPos,
        ...
        if (FilePathFactory.pupilBundleRes().size() > 0) {
            ...
            markUpPairBeanMap.put(TITLE_PUPIL_INDEX, new MultipleItemPair(selectPos,
        ...
        if (FilePathFactory.lipglossBundleRes().size() > 0) {
            ...
            markUpPairBeanMap.put(TITLE_LIPGLOSS_INDEX, new MultipleItemPair(selectPos,
        ...
        if (FilePathFactory.facemakeupBundleRes().size() > 0) {
            ...
            markUpPairBeanMap.put(TITLE_FACEMAKEUP_INDEX, new MultipleItemPair(selectPos,
                                                                       getSelectMakeUp(avatarP2A.getFaceMakeupIndex(), selectPos)));
            selectPos = makeUpList.size() - 1;
        }
        markUpPairBeanMap.put(TITLE_MAKE_UP, new MultipleItemPair(0, hasSelectMakeUp(markUpPairBeanMap) ? -1 : 0));
    }
    ...
    private boolean hasSelectMakeUp(HashMap<Integer, MultipleItemPair> pairBeanMap) {
        boolean hasSelect = false;
        for (Integer key : pairBeanMap.keySet()) {
            MultipleItemPair pairBean = pairBeanMap.get(key);
    ...
    public void initDecorationList(AvatarPTA avatarPTA) {
        ...
        decorationList.add(new SpecialBundleRes(R.drawable.edit_face_selector_item_none, TITLE_DECORATIONS_INDEX, ""));
        ...
        if (FilePathFactory.decorationsHandBundleRes().size() > 0) {
            ...
            decorationPairBeanMap.put(TITLE_DECORATIONS_HAND_INDEX, new MultipleItemPair(currentTypeStartingValue,
        ...
        if (FilePathFactory.decorationsFootBundleRes().size() > 0) {
            ...
            decorationList.addAll(specialBundleRes);
            decorationPairBeanMap.put(TITLE_DECORATIONS_FOOT_INDEX, new MultipleItemPair(currentTypeStartingValue,
        ...
        if (FilePathFactory.decorationsNeckBundleRes().size() > 0) {
            ...
            decorationList.addAll(specialBundleRes);
            decorationPairBeanMap.put(TITLE_DECORATIONS_NECK_INDEX, new MultipleItemPair(currentTypeStartingValue,
        ...
        if (FilePathFactory.decorationsEarBundleRes().size() > 0) {
            ...
            decorationList.addAll(specialBundleRes);
            decorationPairBeanMap.put(TITLE_DECORATIONS_EAR_INDEX, new MultipleItemPair(currentTypeStartingValue,
        ...
        if (FilePathFactory.decorationsHeadBundleRes().size() > 0) {
            ...
            decorationList.addAll(specialBundleRes);
            decorationPairBeanMap.put(TITLE_DECORATIONS_HEAD_INDEX, new MultipleItemPair(currentTypeStartingValue,
                                                                                 getSelectDecoration(avatarPTA.getDecorationsHeadIndex(), currentTypeStartingValue)));
        }
        decorationPairBeanMap.put(TITLE_DECORATIONS_INDEX, new MultipleItemPair(0, hasSelectMakeUp(decorationPairBeanMap) ? -1 : 0));
    }
    ...
    public HashMap<Integer, MultipleItemPair> getDecorationPairBeanMap() {
    ...
    public HashMap<Integer, MultipleItemPair> getMarkUpPairBeanMap() {
