package io.agora.uiwidget.function.editface.seekbar.internal;
...
public class Marker extends ViewGroup implements MarkerDrawable.MarkerAnimationListener {
    ...
    public Marker(Context context, AttributeSet attrs, int defStyleAttr, String maxValue, int thumbSize, int separation) {
        ...
        int textAppearanceId = a.getResourceId(R.styleable.EditFaceDiscreteSeekBar_dsb_indicatorTextAppearance,
        ...
        ColorStateList color = a.getColorStateList(R.styleable.EditFaceDiscreteSeekBar_dsb_indicatorColor);
        ...
        float elevation = a.getDimension(R.styleable.EditFaceDiscreteSeekBar_dsb_indicatorElevation, ELEVATION_DP * displayMetrics.density);
