...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.EditFaceRoundImageView, defStyle, 0);

        mRoundRadius = a.getDimensionPixelSize(R.styleable.EditFaceRoundImageView_round_radius, DEFAULT_ROUND_RADIUS);
        mBorderOverlay = a.getBoolean(R.styleable.EditFaceRoundImageView_round_border_overlay, DEFAULT_BORDER_OVERLAY);
